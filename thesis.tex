...
Erilaisia ihmisen \fixme{kuvauksia} on tehty tuhansien vuosien ajan. Teknologian kehittyessä on löytynyt uudenlaisia tapoja ihmiskehon visuaaliseen esittämiseen. Nykyään on mahdollista luoda kolmiulotteisia virtuaalihahmoja, mutta niiden tekeminen on työlästä ja vaikeaa.

Syvyyskamerat ovat halventuneet ja ovat yleistymässä. Tämä mahdollistaa 3D-skannaamisen kotioloissa. Ohjelmistoja staattisten esineiden skannaamiseen on jo saatavilla, mutta liikkuvan ihmisen mallintaminen on vaikeaa.
}
