...
\begin{figure}
    ...
    \caption{Kinfu showing three different views of a desk: the raytraced TSDF, the raw Kinect depth view, and a mesh generated from the TSDF. \fixme{TODO: split this into three different images and refer to the images}}
