...
One possible approach is to use a voxel grid similar to the one KinectFusion \autocite{newcombe2011kinectfusion}{izadi2011kinectfusion} uses. This allows generating meshes representing arbitrary shapes.
