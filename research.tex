...
To allow for combining data from multiple frames, the observations (point clouds) need to be aligned one way or another. Methods introduced in \ref{literature.alignment} were available, each with their own trade-offs.
