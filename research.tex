...
\fixme{Should the cylinder man have its own subsection? "Geometric surfaces"}
...
\subsection{Parallel Kinfu for each body part} \label{voxelgrid}
...
\subsection{Using a human body model}
